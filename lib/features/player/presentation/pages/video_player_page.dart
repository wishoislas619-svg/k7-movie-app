    ...
    _scraperTimer = Timer.periodic(const Duration(seconds: 1), (timer) async {
     ...
     if (_effectiveAlgorithm == 2 || _effectiveAlgorithm == 3) {
      ...
      for (var p in points) {
        ...
        // 🔥 CRÍTICO: Para Algoritmos 2 y 3, si no hay URL detectada,
        // continuar al scraper principal para hacer polling. No cortar con return.
        if (_effectiveAlgorithm == 2) {
          // Algoritmo 2 ya verificó arriba, si llegó aquí no encontró URL directa.
          // Dejamos que el scraper principal intente la extracción.
        }
        if (_effectiveAlgorithm == 3) {
          // Algoritmo 3: Dejar que el monitor de red / onLoadResource capture la URL
          return;
        }
     }
