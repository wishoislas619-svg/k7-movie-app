...
final class LtStreamStatus extends Struct {
  ...
  @Int64()
  external int readHead;
  @Int32()
  external int streamState;
  @Float()
  external double bufferSeconds;
  @Int32()
  external int bufferPieces;
  @Int32()
  external int readaheadWindow;
  @Int32()
...
final class LtBtConfig extends Struct {
  ...
  @Int32()
  external int readerReadAhead;
  @Int32()
  external int preloadCache;
  @Int32()
  external int connectionsLimit;
  @Int32()
  external int torrentDisconnectTimeout;
  @Int32()
  external int forceEncrypt;
  @Int32()
  external int disableTcp;
  @Int32()
  external int disableUtp;
  @Int32()
  external int disableUpload;
  @Int32()
  external int disableDht;
  @Int32()
  external int disableUpnp;
  @Int32()
  external int enableIpv6;
  @Int32()
  external int downloadRateLimit;
  @Int32()
  external int uploadRateLimit;
  @Int32()
  external int peersListenPort;
  @Int32()
  external int responsiveMode;
}
...
class TorrentBridgeBindings {
  ...
  TorrentBridgeBindings(this._lib) {
    createSession = _lib
        ...
        .asFunction<LtCreateSession>();
    destroySession = _lib
        .lookup<NativeFunction<_DestroySessionN>>('lt_destroy_session')
        .asFunction<LtDestroySession>();
    pollAlerts = _lib
        .lookup<NativeFunction<_PollAlertsN>>('lt_poll_alerts')
        .asFunction<LtPollAlerts>();
    ...
    pauseTorrent = _lib
        .lookup<NativeFunction<_PauseTorrentN>>('lt_pause_torrent')
        .asFunction<LtPauseTorrent>();
    resumeTorrent = _lib
        .lookup<NativeFunction<_ResumeTorrentN>>('lt_resume_torrent')
        .asFunction<LtResumeTorrent>();
    recheckTorrent = _lib
        .lookup<NativeFunction<_RecheckTorrentN>>('lt_recheck_torrent')
        .asFunction<LtRecheckTorrent>();
    getTorrentCount = _lib
        .lookup<NativeFunction<_GetTorrentCountN>>('lt_get_torrent_count')
        .asFunction<LtGetTorrentCount>();
    getAllStatuses = _lib
        .lookup<NativeFunction<_GetAllStatusesN>>('lt_get_all_statuses')
        .asFunction<LtGetAllStatuses>();
    getStatus = _lib
        .lookup<NativeFunction<_GetStatusN>>('lt_get_status')
        .asFunction<LtGetStatus>();
    getFileCount = _lib
        .lookup<NativeFunction<_GetFileCountN>>('lt_get_file_count')
        .asFunction<LtGetFileCount>();
    getFiles = _lib
        .lookup<NativeFunction<_GetFilesN>>('lt_get_files')
        .asFunction<LtGetFiles>();
    setFilePriorities = _lib
        .lookup<NativeFunction<_SetFilePrioritiesN>>('lt_set_file_priorities')
        .asFunction<LtSetFilePriorities>();
    startStream = _lib
    ...
    getStreamStatus = _lib
        .lookup<NativeFunction<_GetStreamStatusN>>('lt_get_stream_status')
        .asFunction<LtGetStreamStatus>();
    getAllStreamStatuses = _lib
        .lookup<NativeFunction<_GetAllStreamStatusesN>>(
          'lt_get_all_stream_statuses',
        )
        .asFunction<LtGetAllStreamStatuses>();
    setDownloadLimit = _lib
        .lookup<NativeFunction<_SetDownloadLimitN>>('lt_set_download_limit')
        .asFunction<LtSetDownloadLimit>();
    setUploadLimit = _lib
        .lookup<NativeFunction<_SetUploadLimitN>>('lt_set_upload_limit')
        .asFunction<LtSetUploadLimit>();
    preloadStream = _lib
        .lookup<NativeFunction<_PreloadStreamN>>('lt_preload_stream')
        .asFunction<LtPreloadStream>();
    setCacheSettings = _lib
        .lookup<NativeFunction<_SetCacheSettingsN>>('lt_set_cache_settings')
        .asFunction<LtSetCacheSettings>();
    configureSession = _lib
        .lookup<NativeFunction<_ConfigureSessionN>>('lt_configure_session')
        .asFunction<LtConfigureSession>();
    getDefaultConfig = _lib
        .lookup<NativeFunction<_GetDefaultConfigN>>('lt_get_default_config')
        .asFunction<LtGetDefaultConfig>();
    getActiveStreams = _lib
        .lookup<NativeFunction<_GetActiveStreamsN>>('lt_get_active_streams')
        .asFunction<LtGetActiveStreams>();
    lastError = _lib
        .lookup<NativeFunction<_LastErrorN>>('lt_last_error')
        .asFunction<LtLastError>();
    version = _lib
  ...
  factory TorrentBridgeBindings.open() =>
      TorrentBridgeBindings(_openNativeLib());
}
